...
export const exportExcelProcedure = publicProcedure
  ...
  .query(({ input }) => {
    ...
    const exportData = clients.map((client) => ({
      ...
      'Días de Crédito': client.hasCredit && client.creditDays ? client.creditDays : 'N/A',
      'Tiene Descuento': client.hasDiscount ? 'Sí' : 'No',
      'Descuento (MXN)': client.hasDiscount && client.discountAmount ? client.discountAmount : 'N/A',
